(function() {
  ...
  const config = {
    ...
    targetSelectorLargeDesktop: '.product-view__main', // For skjermer bredere enn 1024px
    targetSelectorMediumDesktop: '.product-view__main', // For skjermer mellom 768px og 1028px (kun første)
