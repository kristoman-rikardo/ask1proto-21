(function() {
  ...
  const config = {
    ...
    targetSelectorLargeDesktop: '.similar-product-list__title', // For skjermer bredere enn 1024px
    targetSelectorMediumDesktop: '.similar-product-list__title', // For skjermer mellom 768px og 1028px (kun første)
