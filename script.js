(function() {
  ...
  const config = {
    ...
    targetSelectorLargeDesktop: '.actions-wrapper', // For skjermer bredere enn 1024px
    targetSelectorMediumDesktop: '.actions-wrapper', // For skjermer mellom 768px og 1028px (kun første)
